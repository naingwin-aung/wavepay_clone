                    ...
                    <div class="card-body">
                        <form action="{{route('user.transferComplete')}}" id="transfer" method="POST" autocomplete="off">
                            ...
                            <div class="text-center mb-4">
                                ...
                                <h4 class="mb-4"><span class="text-primary">{{number_format($amount)}}</span> <span class="@if (App::isLocale('en')) small @endif">@lang('public.kyat')</span></h4>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 text-right">
                                    <p class="eng_letter mb-0"><span class="font-weight-bold">{{number_format($amount)}}</span> <span class="@if (App::isLocale('en')) small @endif">@lang('public.kyat')</span></p>
                                </div>
                            </div>
                            <hr>
                            
                            <p class="mt-4 mb-0">@lang('public.balance') - <span class="eng_letter text-primary">{{number_format($remainingAmount)}}</span> <span class="@if (App::isLocale('en')) small @endif">@lang('public.kyat')</span></p>
